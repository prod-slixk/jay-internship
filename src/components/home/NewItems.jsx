...
// keen-slider install: npm install keen-slider

/**
 * Computes a live countdown string from an expiry date timestamp
 * @param {string|number} expiryDate - ISO date string or Unix timestamp from API
 * @returns {string} formatted countdown e.g. "5h 30m 12s" or "Expired"
 */
    ...
    <section id="section-items" className="no-bottom">
      <div className="container">
        <div className="row">
          ...
          {/* Carousel wrapper — arrows sit outside the track */}
